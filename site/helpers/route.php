...
/**
 * Ezpz Component Helper file for generating the URL Routes
 *
 */
class EzpzHelperRoute
{
    /**
     * When the Ezpz message is displayed then there is also shown a map with a Search Here button.
    ...
    public static function getAjaxURL()
    {
        ...
        if ($menuitem)
        {
            ...
            $url = JRoute::_("index.php?Itemid=$itemid&view=ezpz&format=json");
            return $url;
        }
        else
        {
    ...
    /**
     * Helper function for generating the URL to a Ezpz page
     * This is needed for the Tags functionality
     */
    public static function getEzpzRoute($id, $catid = 0, $language = 0)
    {
        // Create the link
        $link = 'index.php?option=com_ezpz&view=ezpz&id=' . $id;
    ...
    /**
     * Helper function for generating the URL to a Ezpz Category page
     * This is needed for the Tags functionality
     */
    public static function getCategoryRoute($catid, $language = 0)
    {
        ...
        {
            $link = 'index.php?option=com_ezpz&view=category&id=' . $id;
