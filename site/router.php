...
class EzpzRouter implements JComponentRouterInterface
{
    ...
    public function build(&$query)
    {
        ...
        if ($thisMenuitem->note == "Ajax")
        {
            ...
            if ($query['view'] == "ezpz" && isset($query['id']))
            {
        ...
        else
        {
            ...
            elseif ($query['view'] == "ezpz" && isset($query['catid']) && isset($query['id']))
            {
    ...
    {
        $categories = JCategories::getInstance('Ezpz', array());
    ...
    public function parse(&$segments)
    {
        ...
        {
            // Expect 1 segment of the form id:alias for the ezpz record
            if ($nSegments == 1)
            {
                $vars['id'] = $segments[0];
                $vars['view'] = 'ezpz';
        ...
        else
        {
            ...
            // The last segment may be a category id:alias or a ezpz record id:alias
