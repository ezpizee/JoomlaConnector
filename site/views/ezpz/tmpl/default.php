...
<?php if ($this->parentItem->id > 1) : ?>
    <h1><?php echo JText::_('COM_EZPZ_PARENT') ?>
    </h1>
    <h3>
        <?php $url = JRoute::_('index.php?option=com_ezpz&view=ezpz&id=' . $this->parentItem->id . ':' . $this->parentItem->alias . '&catid=' . $this->parentItem->catid . $query_lang); ?>
...
<?php if ($this->children) :
    ...
    <h1><?php echo JText::_('COM_EZPZ_CHILDREN') ?>
    </h1>
    ...
    <h3>
        ...
        <?php echo $prefix; ?>
        <?php $url = JRoute::_('index.php?option=com_ezpz&view=ezpz&id=' . $child->id . ':' . $child->alias . '&catid=' . $child->catid . $query_lang); ?>
...
$fields = FieldsHelper::getFields('com_ezpz.ezpz', $this->item, true);
...
<div id="searchmap">
    ...
    <button type="button" class="btn btn-primary" onclick="searchHere();">
        <?php echo JText::_('COM_EZPZ_SEARCH_HERE_BUTTON') ?>
    </button>
